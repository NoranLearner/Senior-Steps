...
--
-- Host: localhost
-- Generation Time: Nov 23, 2023 at 06:30 AM
...
CREATE TABLE `departments` (
  `department_id` int(8) NOT NULL COMMENT 'primary key column of departments table.',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='departments table that shows details of departments where employees\r\nwork. contains 27 rows; references with locations, employees, and job_history tables.';
...
CREATE TABLE `employees` (
  `employee_id` int(6) NOT NULL COMMENT 'primary key of employees table.',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='employees table. contains 107 rows. references with departments,\r\njobs, job_history tables. contains a self reference.';
...
CREATE TABLE `locations` (
  `location_id` smallint(4) NOT NULL COMMENT 'primary key of locations table',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='locations table that contains specific address of a specific office,\r\nwarehouse, and/or production site of a company. does not store addresses /\r\nlocations of customers. contains 23 rows; references with the\r\ndepartments and countries tables.';
...
INSERT INTO `users` (`id`, `username`, `email`, `password`, `type`, `gender`) VALUES
(1, 'Noran', 'noran@gmail.com', '1234', 'normal', 'female'),
(2, 'Noran', 'noran@gmail.com', '1234', 'normal', 'female'),
(3, 'nn', 'nn@gmail.com', '1234', '', 'male'),
(4, '', '', '', '', 'male'),
(5, '', '', '', '', 'male'),
(6, '', '', '', '', 'male'),
(7, 'nm', 'nm@gmail.com', '1234', '', 'male'),
(8, '', '', '', '', 'male'),
(9, '', '', '', '', 'male');
...
ALTER TABLE `job_history`
  ...
  ADD KEY `jhist_emp_fk` (`employee_id`),
...
--
ALTER TABLE `departments`
  MODIFY `department_id` int(8) NOT NULL AUTO_INCREMENT COMMENT 'primary key column of departments table.', AUTO_INCREMENT=311;

--
-- AUTO_INCREMENT for table `employees`
--
ALTER TABLE `employees`
  MODIFY `employee_id` int(6) NOT NULL AUTO_INCREMENT COMMENT 'primary key of employees table.', AUTO_INCREMENT=214;

--
-- AUTO_INCREMENT for table `locations`
--
ALTER TABLE `locations`
  MODIFY `location_id` smallint(4) NOT NULL AUTO_INCREMENT COMMENT 'primary key of locations table', AUTO_INCREMENT=3201;

--
-- AUTO_INCREMENT for table `my_emps`
--
ALTER TABLE `my_emps`
